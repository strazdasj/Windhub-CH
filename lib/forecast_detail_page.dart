...
class ForecastDetailPage extends StatefulWidget {
  ...
  const ForecastDetailPage(
      {super.key, required this.lake, required this.lake_img});
  @override
  State<StatefulWidget> createState() => _ForecastDetailState();
}

class _ForecastDetailState extends State<ForecastDetailPage> {
